...
<div id="header-wrapper">
	...
	<div id="banner" class="container">
		<div style="font-size: 25px; background: white; margin: 0 auto; padding: 30px; opacity: 0.6; margin-bottom: 15px; color: red;">
				You are black listed for posting new feeds, please contact Admin.
		</div>
	</div>
</div>
<div id="wrapper">
