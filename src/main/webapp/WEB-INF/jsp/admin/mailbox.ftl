...
<html>
    <head>
        ...
        <link href="/static/admin/css/iCheck/minimal/blue.css" rel="stylesheet" type="text/css" />
        <!-- Theme style -->
    ...
    <body class="skin-blue">
        ...
        <!-- Bootstrap WYSIHTML5 -->
        <script src="/static/admin/jsplugins//bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js" type="text/javascript"></script>
        <!-- iCheck -->
        <script src="/static/admin/jsplugins//iCheck/icheck.min.js" type="text/javascript"></script>
        <!-- Page script -->
